...
if (($row_HX['HSUBCAT'] < 53 || $xxx < 53) || ($row_HX['HSUBCAT'] > 80 || $xxx > 80)){
		...
		echo "<tr height='15'>";
			...
			elseif ($xxx=='15'){
					//Data
					echo "<td valign='top' align='right'>";
					echo "<span style='background-color:#FFFF00; color:#FF0000;'>Data:</span>&nbsp;&nbsp;";
					}
			elseif ($xxx=='16'){
					//Assessment
					echo "<td valign='top' align='right'>";
			...
			elseif ($xxx=='19'){
					//Procedure
					echo "<td valign='top' align='right'>";
					echo "<span style='background-color:#FFFF00; color:#FF0000;'>Procedure:</span>&nbsp;&nbsp;";
					}
			elseif ($xxx=='18'){
					//Case Summary
					echo "<td valign='top' align='right'>";
...
//NON-HEADING ENTRIES
if (($row_HX['HSUBCAT'] > 53 && $row_HX['HSUBCAT'] < 80) || $row_HX['HSUBCAT']==29){
