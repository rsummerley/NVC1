...
<tr>
          ...
          <tr>
            ...
            <img src="../IMAGES/e3 copy.jpg" alt="e" id="e" width="30" height="30" onclick="window.open('INSERT_PATIENT.php?patient=<?php echo $patient; ?>&client=<?php echo $client; ?>&species=<?php echo $row_PATIENT_CLIENT['PETTYPE']; ?>','_parent')" onmouseover="CursorToPointer(this.id)" title="Click to edit <?php echo mysql_real_escape_string($petname); ?>"/>
            <img src="../IMAGES/v copy.jpg" alt="v" id="v" width="30" height="30" class="style1" onclick="window.open('PATIENT_DETAIL.php?patient=<?php echo $patient; ?>','_blank','width=660,height=540')"  onmouseover="CursorToPointer(this.id)" title="Click to open <?php echo mysql_real_escape_string($petname); ?>'s detail"/>
            <img src="../IMAGES/h copy.jpg" alt="h" id="h" width="30" height="30" onclick="sessionStorage.setItem('prefID',sessionStorage.refID); sessionStorage.setItem('refID','REVIEW MED. HISTORYx'); openpage('<?php echo $patient; ?>','<?php echo mysql_real_escape_string($custname); ?>', '<?php echo $custphone; ?>','<?php echo mysql_real_escape_string($petname); ?>','<?php echo mysql_real_escape_string($desco); ?>','<?php echo mysql_real_escape_string($desct); ?>','<?php echo $custprevbal; ?>','<?php echo $custcurbal; ?>','<?php echo $custterm; ?>','<?php echo $psex; ?>','<?php echo $pdob; ?>','<?php echo $row_PATIENT_CLIENT['PETTYPE']; ?>','<?php echo mysql_real_escape_string($address); ?>','<?php echo mysql_real_escape_string($city); ?>');"  onmouseover="CursorToPointer(this.id)" title="Click to review <?php echo mysql_real_escape_string($petname); ?>'s medical history"/>
          ...
          <tr>
            ...
            <input type="button" name="goto" id="goto" value="" class="customizedbutton" onclick="openpage('<?php echo $patient; ?>','<?php echo mysql_real_escape_string($custname); ?>', '<?php echo $custphone; ?>','<?php echo mysql_real_escape_string($petname); ?>','<?php echo mysql_real_escape_string($desco); ?>','<?php echo mysql_real_escape_string($desct); ?>','<?php echo $custprevbal; ?>','<?php echo $custcurbal; ?>','<?php echo $custterm; ?>','<?php echo $psex; ?>','<?php echo $pdob; ?>','<?php echo $row_PATIENT_CLIENT['PETTYPE']; ?>','<?php echo mysql_real_escape_string($address); ?>','<?php echo mysql_real_escape_string($city); ?>','<?php echo $custlmonbal ;?>');" <?php if ($row_PATIENT_CLIENT['LOCKED']=='1' && $_GET['refID']=='REG'){ echo "style='display:none;'";} ?>/>
