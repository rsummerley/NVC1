...
if (isset($_POST['save'])){ 
$updateSQL = sprintf("UPDATE EXAMHOLD2 SET BEHAVIOURMEMO = '%s' WHERE PETNO = '$patient'", 
				mysqli_real_escape_string($mysqli_link, $_POST['behaviourmemo'])
				);
...
document.behav.behaviourmemo.focus();
}
...
<form method="post" action="" name="behav" style="position:absolute; top:0px; left:0px;">

<table width="500" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="98" height="18" class="Labels"></td>
    <td width="132" height="18" class="Labels"></td>
    <td width="70" height="18" class="Labels"></td>
    <td width="70" height="18" class="Labels"></td>
    <td width="90" height="18" class="Labels"></td>
    <td width="40" height="18" class="Labels"></td>
  </tr>
    <tr>
    <td align="right" valign="top" class="Verdana12">Comments:</td>
    <td colspan="4" class="Labels"><textarea name="behaviourmemo" cols="40" rows="6" class="commentarea" id="behaviourmemo"><?php echo $row_EXAM['BEHAVIOURMEMO']; ?></textarea></td>
    <td align="right" valign="bottom" class="Labels"><img src="../../../IMAGES/h copy.jpg" alt="h" width="30" height="30" class="hidden" /></td>
    </tr>
  <tr>
    <td height="31" colspan="6" align="right"></td>
  </tr>
  <tr>
