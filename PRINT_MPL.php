...
$TRIM_HX = mysqli_query($tryconnection, $TRIM_HX) or die(mysqli_error($mysqli_link)) ;
...
$GET_APPT = mysqli_query($tryconnection, $APPT) or die(mysqli_error($mysqli_link)) ;
$row_APPT = mysqli_fetch_assoc($GET_APPT) ;
